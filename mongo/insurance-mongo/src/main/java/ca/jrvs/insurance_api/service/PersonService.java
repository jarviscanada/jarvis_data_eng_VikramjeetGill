...
public class PersonService {
    ...
    public Optional<Person> findOne(ObjectId id) {
        Optional<Person> result = repo.findById(id.toString()); // I might need to check this later for errors if theres something wrong with the conversion of id to string.
        return result;
    }
